<form role="form" action="../controllers/OrdenProductoControlador.php?accion=error" method="POST">
              <div class="box-body">
                    ...
                    <td></td>
                        ...
                        <td>'.$row['nombre'].'</td>
                           ...
                           <td>'.$row["cantidad_utilizado"].'</td>
                            ...
                            <td><input type="number" name="repuesto[]" id="repuesto[]"/></td>
                          <input type="hidden" name="id" id="id" value="'.$row['id_orden_producto'].'"/>
                          <input type="hidden" name="id_do[]" id="id_do[]" value="'.$row['id_detalle_orden'].'"/>
                          <input type="hidden" name="pl" id="pl" value="'.$pl.'"/> 
                          <input type="hidden" name="bodega[]" id="bodega[]" value="'.$row['id_bodega'].'"/>
