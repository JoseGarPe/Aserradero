...
<head>
    ...
    <title>Tipo Usuarios | Aserradero</title>
          ...
          <div class="main_container">
            ...
            <div class="right_col" role="main">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pagina de Tipo de Usuarios</h2>
   ...
   <div id="dataModal2" class="modal fade">  
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 <button type="button" class="close" data-dismiss="modal">&times;</button>  
                                                 <h4 class="modal-title">Detalles de Tipo Usuario</h4>  
                                            </div>  
                                            <div class="modal-body" id="employee_forms2">  
                                            </div>  
   ...
   $(document).ready(function(){  
      ...
      $(document).on('click', '.edit_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/TipoUsuario/modiTipoUsuario.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.view_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/TipoUsuario/selectTipoUsuario.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
                          $('#employee_forms2').html(data);  
        ...
        $(document).on('click', '.save_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/TipoUsuario/saveTipoUsuario.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.delete_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/TipoUsuario/deleteTipoUsuario.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
