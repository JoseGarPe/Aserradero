             ...
             ?></div>
                  <div class="x_content">
                   ...
                   <input type="button" name="accion" value="Seleccionar Preset" id="accion" class="btn btn-success selec_data" /> 
                    <br>
                    <br>
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../controllers/reportePDFControlador.php?accion=ordenes" method="post">
                    <?php 
...
xmlhttp.open("POST","../views/DetalleProducto/inputConsultas.php",true);
