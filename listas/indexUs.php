                  ...
                  <ul class="nav navbar-nav navbar-right">
                    <li class="">
                      ...
                      <ul class="dropdown-menu dropdown-usermenu pull-right">
                        ...
                        <li><a href="../controllers/LoginControlador.php?accion=logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                      </ul>
                    </li>
...
function timerIncrement() {
       ...
       if (idleTime > 8) { // 20 minutes
         ...
         alert("Esta usted ahi? Su sesion se cerrara por seguridad");
       }
}
</script> 
    </body>
