            ...
            <div class="col-md-3 left_col">
              <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                  <a href="../indexAdmin.php" class="site_title"><i class="fa fa-paw"></i> <span>Bodega</span></a>
                </div>
  ...
  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
             ...
             ?></div>
                  <div class="x_content">
                   ...
                   <input type="button" name="accion" value="Nueva Bodega" id="accion" class="btn btn-success save_data" /> 
                    <br>
                    <br>
                         ...
                         echo '
                          <tr>
                           ...
                           <td>
                                    ...
                                    <input type="button" name="view" value="Ver Detalle" id="'.$row["id_bodega"].'" class="btn btn-info view_data"/>  
                                    <input type="button" name="edit" value="Editar" id="'.$row["id_bodega"].'" class="btn btn-warning edit_data" />
                                     <input type="button" name="delete" value="Eliminar" id="'.$row["id_bodega"].'" class="btn btn-danger delete_data" />
                           </td>
                          </tr>
                         ';
                       }
                                  ...
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 ...
                                                 <h4 class="modal-title">Detalle Bodega</h4>  
                                            </div>  
   ...
   $(document).ready(function(){  
      ...
      $(document).on('click', '.edit_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/bodega/modiBodega.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.view_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/bodega/selectBodega.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
                          $('#employee_forms2').html(data);  
        ...
        $(document).on('click', '.save_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/bodega/saveBodega.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.delete_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/bodega/deleteBodega.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
