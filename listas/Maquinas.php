  ...
  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
             ...
             ?></div>
                  <div class="x_content">
                   ...
                   <input type="button" name="accion" value="Nueva Maquina" id="accion" class="btn btn-success save_data" /> 
                    <br>
                    <br>
                         ...
                         echo '
                          <tr>
                           ...
                           <td>
                                    ...
                                    <input type="button" name="view" value="Ver Detalle" id="'.$row["id_maquina"].'" class="btn btn-info view_data"/>  
                                    <input type="button" name="edit" value="Editar" id="'.$row["id_maquina"].'" class="btn btn-warning edit_data" />
                                     <input type="button" name="delete" value="Eliminar" id="'.$row["id_maquina"].'" class="btn btn-danger delete_data" />
                           </td>
                          </tr>
                         ';
                       }
                                  ...
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 ...
                                                 <h4 class="modal-title">Detalle Maquina</h4>  
                                            </div>  
     ...
     <div id="dataModal3" class="modal fade">  
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 <button type="button" class="close" data-dismiss="modal">&times;</button>  
                                                 <h4 class="modal-title">Agregar Nueva Maquina</h4>  
                                            </div>  
   ...
   $(document).ready(function(){ 
      ...
      $(document).on('click', '.view_data', function(){  
        ...
        $(document).on('click', '.save_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/maquinas/saveMaquinas.php",  
                     method:"POST",  
