                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" name="datatable-buttons">
                      ...
                      <tbody>
                        <?php 
                         ...
                         $catego3 = $miMaterial->selectALL_Pintura();
                        
                           # code...
                         
                         foreach ((array)$catego3 as $row3) {
                         echo '
                          <tr>
                           <td>'.$row3['id_insumo'].'</td>
                           <td>'.$row3['nombre_insumo']. '</td>
                           <td>'.$row3['stock'].'</td>
                          <td>
                                       <a class="btn btn-info view_data" href="movimientos.php?id_insumo='.$row3["id_insumo"].'">Ver movimientos</a>
                                  <!--  <input type="button" name="view" value="Ver Movimiento" id="" class="btn btn-info view_data"/>  -->
                                    <input type="button" name="edit" value="Editar" id="'.$row3["id_insumo"].'" class="btn btn-warning edit_data" />
                                     <input type="button" name="delete" value="Eliminar" id="'.$row3["id_insumo"].'" class="btn btn-danger delete_data" />
                           </td>
                          </tr>
                         ';
                       }
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" name="datatable-buttons">
                      ...
                      <tbody>
                        <?php 
                         require_once "../class/Insumo.php";
                         $miMaterial = new Insumo();
                         $catego1 = $miMaterial->selectALL_clavo();
                        
                           # code...
                         
                         foreach((array)$catego1 as $row2) {
                         echo '
                          <tr>
                           <td>'.$row2['id_insumo'].'</td>
                           <td>'.$row2['nombre_insumo']. '</td>
                           <td>'.$row2['stock'].'</td>
                          <td>
                                      <a class="btn btn-info view_data" href="movimientos.php?id_insumo='.$row2["id_insumo"].'">Ver movimientos</a>
                                  <!--  <input type="button" name="view" value="Ver Movimiento" id="" class="btn btn-info view_data"/>  -->
                                    <input type="button" name="edit" value="Editar" id="'.$row2["id_insumo"].'" class="btn btn-warning edit_data" />
                                     <input type="button" name="delete" value="Eliminar" id="'.$row2["id_insumo"].'" class="btn btn-danger delete_data" />
                           </td>
                          </tr>
                         ';
                       }
   ...
   $(document).ready(function(){ 
      ...
      $(document).on('click', '.edit_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/Insumos/modiInsumos.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.view_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/Insumos/selectInsumos.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
                          $('#employee_forms2').html(data);  
        ...
        $(document).on('click', '.save_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/Insumos/saveInsumo.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.delete_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/Insumos/deleteInsumos.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
