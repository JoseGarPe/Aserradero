                         ...
                         echo '
                          <tr>
                           ...
                           <td>
                                    ...
                                    <input type="button" name="view" value="Ver Detalle" id="'.$row["id_shipper"].'" class="btn btn-info view_data"/>  
                                    <input type="button" name="edit" value="Editar" id="'.$row["id_shipper"].'" class="btn btn-warning edit_data" />
                                     <input type="button" name="delete" value="Eliminar" id="'.$row["id_shipper"].'" class="btn btn-danger delete_data" />
                           </td>
                          </tr>
                         ';
                       }
                                  ...
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 ...
                                                 <h4 class="modal-title">Detalle Shipper</h4>  
                                            </div>  
     ...
     <div id="dataModal3" class="modal fade">  
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 <button type="button" class="close" data-dismiss="modal">&times;</button>  
                                                 <h4 class="modal-title">Agregar Nuevo Shipper</h4>  
                                            </div>  
      ...
      <div id="dataModal4" class="modal fade">  
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 <button type="button" class="close" data-dismiss="modal">&times;</button>  
                                                 <h4 class="modal-title">Eliminar Shipper</h4>  
                                            </div>  
   ...
   $(document).ready(function(){ 
      ...
      $(document).on('click', '.edit_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/shipper/modiShipper.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.view_data', function(){  
        ...
        $(document).on('click', '.save_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/shipper/saveShipper.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.delete_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/shipper/deleteShipper.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
