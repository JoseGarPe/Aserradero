          ...
          <div class="main_container">
            ...
            <div class="right_col" role="main">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pagina de Especificaciones</h2>
  ...
  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
             ...
             ?></div>
                  <div class="x_content">
                   ...
                   <input type="button" name="accion" value="Nueva Especificacion" id="accion" class="btn btn-success save_data" /> 
                    <br>
                    <br>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" name="datatable-buttons">
                      ...
                      <tbody>
                        <?php 
                         ...
                         $misEspe = new Especificacion();
                         $todos = $misEspe->selectALL();
                         ...
                         echo '
                          <tr>
                           <td>'.$row['id_especificacion'].'</td>
                           <td>'.$row['nombre'].'</td>
                           <td>'.$row['descripcion'].'</td>
                           <td>
                          
                                    <input type="button" name="view" value="Ver Detalle" id="'.$row["id_especificacion"].'" class="btn btn-info view_data"/>  
                                    <input type="button" name="edit" value="Editar" id="'.$row["id_especificacion"].'" class="btn btn-warning edit_data" />
                                     <input type="button" name="delete" value="Eliminar" id="'.$row["id_especificacion"].'" class="btn btn-danger delete_data" />
                           </td>
                          </tr>
                         ';
                       }
                                  ...
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 ...
                                                 <h4 class="modal-title">Detalle Especificacion</h4>  
                                            </div>  
     ...
     <div id="dataModal3" class="modal fade">  
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 <button type="button" class="close" data-dismiss="modal">&times;</button>  
                                                 <h4 class="modal-title">Agregar Nueva Especificacion</h4>  
                                            </div>  
      ...
      <div id="dataModal4" class="modal fade">  
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 <button type="button" class="close" data-dismiss="modal">&times;</button>  
                                                 <h4 class="modal-title">Eliminar Especificacion</h4>  
                                            </div>  
   ...
   $(document).ready(function(){ 
      ...
      $(document).on('click', '.edit_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/especificacion/modiEspecificacion.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.view_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/selectEspecificacion.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
                          $('#employee_forms2').html(data);  
        ...
        $(document).on('click', '.save_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/especificacion/saveEspecificacion.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.delete_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/especificacion/deleteEspecificacion.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
