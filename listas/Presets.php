...
<head>
    ...
    <title>Presets | Aserradero</title>
  ...
  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
             ...
             ?></div>
                  <div class="x_content">
                   ...
                   <input type="button" name="accion" value="Nueva Presets" id="accion" class="btn btn-success save_data" /> 
                    <br>
                    <br>
                         ...
                         echo '
                          <tr>
                           ...
                           <td>
                                    ...
                                    <input type="button" name="view" value="Ver Detalle" id="'.$row["id_preset"].'" class="btn btn-info view_data"/>  
                                    <input type="button" name="edit" value="Editar" id="'.$row["id_preset"].'" class="btn btn-warning edit_data" />
                                     <input type="button" name="delete" value="Eliminar" id="'.$row["id_preset"].'" class="btn btn-danger delete_data" />
                           </td>
                          </tr>
                         ';
                       }
                                  ...
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 ...
                                                 <h4 class="modal-title">Detalle Presets</h4>  
                                            </div>  
...
<div id="add_data_Modal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title">Agregar nueva Presets</h4>  
                </div>  
   ...
   $(document).ready(function(){  
      ...
      $(document).on('click', '.edit_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/Presets/modiPreset.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.view_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/Presets/selectPreset.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
                          $('#employee_forms2').html(data);  
        ...
        $(document).on('click', '.save_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/Presets/savePreset.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.delete_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/Presets/deletePreset.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
