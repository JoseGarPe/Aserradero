...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-12-2018 a las 22:45:21
...
(4, 'KA12A', '400', 0.10, '0.10', '1', 3, 1, 250, 4, 0, 'Confirmado');
...
INSERT INTO `orden_producto` (`id_orden_producto`, `id_bodega`, `cantidad`, `estado`, `fase`, `id_preset`, `fecha_orden`) VALUES
(3, 4, 5, 'Sin Confirmar', 'NULL', 1, NULL),
(4, 4, 5, 'Sin Confirmar', 'NULL', 1, NULL),
(5, 4, 5, 'Sin Confirmar', 'NULL', 1, NULL),
(6, 4, 5, 'Sin Confirmar', 'NULL', 1, NULL),
(7, 4, 5, 'Sin Confirmar', 'NULL', 1, NULL),
(8, 4, 5, 'Sin Confirmar', 'NULL', 1, NULL),
(9, 4, 5, 'Sin Confirmar', 'NULL', 1, '2018-12-13');
...
--
DELIMITER $$
CREATE TRIGGER `permisosUsuario` BEFORE INSERT ON `tipo_usuario` FOR EACH ROW INSERT INTO permisos(id_permiso,id_tipo_usuario,campo_a,campo_b,campo_c,campo_d,campo_e,campo_f,campo_g,campo_h,campo_i,campo_j,campo_k,campo_l,campo_m,campo_n,campo_o,campo_p,campo_q,campo_r,campo_s,campo_t,campo_u)
values(NULL,new.id_tipo_usuario,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL)
$$
DELIMITER ;
...
--
ALTER TABLE `detalle_procesado`
  MODIFY `id_detalle_procesado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
...
--
ALTER TABLE `orden_producto`
  MODIFY `id_orden_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `temporal`
  MODIFY `id_temporal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
