...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-12-2018 a las 00:12:59
...
--
ALTER TABLE `detalle_bodega`
  MODIFY `id_detalle_bodega` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `detalle_preset`
  MODIFY `id_detalle_preset` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
