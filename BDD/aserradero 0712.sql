...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2018 a las 09:36:52
...
(1, 1, 10, 1, 2, 10, 10, 2, 'Confirmado'),
(2, 1, 10, 1, 2, 5, 10, 2, 'Sin Confirmar'),
(3, 1, 10, 1, 2, 2, 3, 2, 'Sin Confirmar');
...
(1, '1', '1', 'x', 'enero', '2018-12-06', '3', '3', '10', '5', 'rewa', 1, 1, 1, 'abierto');
...
--
ALTER TABLE `detalle_bodega`
  MODIFY `id_detalle_bodega` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `detalle_preset`
--
ALTER TABLE `detalle_preset`
  MODIFY `id_detalle_preset` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `detalle_procesado`
--
ALTER TABLE `detalle_procesado`
  MODIFY `id_detalle_procesado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
