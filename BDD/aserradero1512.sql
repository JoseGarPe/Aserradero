...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-12-2018 a las 22:53:45
...
INSERT INTO `permisos` (`id_permiso`, `id_tipo_usuario`, `campo_a`, `campo_b`, `campo_c`, `campo_d`, `campo_e`, `campo_f`, `campo_g`, `campo_h`, `campo_i`, `campo_j`, `campo_k`, `campo_l`, `campo_m`, `campo_n`, `campo_o`, `campo_p`, `campo_q`, `campo_r`, `campo_s`, `campo_t`, `campo_u`) VALUES
(1, 1, 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', 'Si', '', 'Si', 'Si', 'Si', 'Si'),
(2, 4, '', '', '', 'Si', 'Si', '', '', 'Si', '', '', 'Si', '', '', '', '', '', '', '', '', '', '');
...
--
ALTER TABLE `orden_producto`
  MODIFY `id_orden_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
